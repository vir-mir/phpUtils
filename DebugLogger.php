	...
	class DebugLogger {
		...
		public static function show()
		{
			...
			foreach (self::$storage as $storage) {
				xdebug_var_dump($storage);
			}
			echo '</pre>';
		}
	}
	runkit_function_redefine('var_dump', '', 'foreach (func_get_args() as $item) DebugLogger::add($item);');
}
